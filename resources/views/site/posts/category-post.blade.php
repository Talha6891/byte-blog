...
@section('content')
    <div class="section search-result-wrap">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="heading fw-bold"> {{ __('Category: ') }} {{ Str::title($category->name) }}</div>
                </div>
            </div>
                ...
                @forelse($categoryPosts as $post)
                    <div class="col-lg-12">
                        <div class="blog-entry d-flex">
                            ...
                            <div>
                                <span class="date">{{ $post->created_at->format('F j, Y') }}  <a href="">{{ Str::title($category->name) }}</a></span>
                    ...
                    @empty
                        <p class="text-center text-danger fw-bold">{{ __('No Category Found') }}</p>
                @endforelse
            </div>
        </div>
    </div>
