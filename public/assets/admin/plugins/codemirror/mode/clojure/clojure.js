...
CodeMirror.defineMode("clojure", function (options) {
    ...
    var builtins = makeKeywords(
        ...
        "aclone add-classpath add-watch agent agent-errors agent-errors aget alength alias all-ns alter alter-meta! " +
        ...
        "drop-while eduction empty empty? ensure enumeration-seq errors-handler errors-mode eval even? every-pred every? ex-data ex-info " +
        ...
        "seque sequence sequential? set set-errors-handler! set-errors-mode! set-validator! set? short short-array shorts " +
