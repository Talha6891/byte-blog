...
(function() {
  ...
  MT('param-scope-test',
     ...
     '  [keyword {][variable-2&errors $x][keyword }]',
     '[keyword {/template}]',
     '');

  MT('if-variable-test',
     '[keyword {if] [variable-2&errors $showThing][keyword }]',
     '  Yo!',
     '[keyword {/if}]',
     '');
  ...
  MT('foreach-scope-test',
     ...
     '[keyword {foreach] [def $foo] [keyword in] [variable-2&errors $foos][keyword }]',
     '  [keyword {][variable-2 $foo][keyword }]',
     '[keyword {/foreach}]',
     '[keyword {][variable-2&errors $foo][keyword }]',
  ...
  MT('tag-starting-with-function-call-is-not-a-keyword',
     '[keyword {]index([variable-2&errors $foo])[keyword }]',
